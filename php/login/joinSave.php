...
<?php
    ...
    if($check_number == false){
        msg("번호가 정확하지 않습니다. <br>올바른 번호(000-0000-0000) 적어주세요!");
    }
    ...
    if($isEmailCheck == true && $isPhoneCheck = true){
        $sql = "INSERT INTO myMember(youEmail, youPass, youName, youBirth, youPhone, regTime, youIntro, youImgFile, youImgSize) VALUES('$youEmail', '$youPass', '$youName', '$youBirth', '$youPhone', '$regTime', '본인에 대해 소개해주세요', 'default.svg', '40227')";
        $result = $connect -> query($sql);
